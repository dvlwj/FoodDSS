			...
			<div class="col-md-8 col-md-offset-2">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<a href="datamakanan tambah.php" class="btn btn-primary">
							Tambah Data
						</a>
						...
						<tbody>
							<?php
								$sql    = 'SELECT * FROM makanan WHERE kd_makanan != "0"';
								$query  = mysqli_query($con, $sql);
								while ($row = mysqli_fetch_array($query))
								{
									echo "<tr>
										<td class='text-center'>" . $row['id'] . "</td>
										<td class='text-center'>" . $row['kd_makanan'] . "</td>
										<td class='text-center'>" . $row['nama'] . "</td>
										<td><a href='datamakanan edit.php?id=" .$row['id']. "' class='btn btn-warning btn-sm'>Edit</a>
											<a href='php/makanan delete.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Delete</a>
										</td>
									<tr>";  
								}
							?>
