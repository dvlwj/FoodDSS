			...
			<div class="col-md-8 col-md-offset-2">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						?>
						<form action="php/makanan update.php" method="POST">
							<input type="hidden" class="form-control" name="id" value="<?php echo $row['id']; ?>">
							<div class="form-group">
								<label for="kd_makanan" class="control-label">Kode Makanan</label>
								<input type="text" class="form-control" name="kd_makanan" placeholder="Kode Makanan" value="<?php echo $row['kd_makanan']; ?>">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<a href="datamakanan.php" class="btn btn-default">Kembali</a>
							</div>
						</form>
					</div>
				</div>            
