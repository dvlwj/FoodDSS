			...
			<div class="col-md-8 col-md-offset-2">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<?php
							$id = $_GET['id'];
							$sql = "SELECT * FROM subkriteria WHERE id = $id";
							$query  = mysqli_query($con, $sql);
							$row = mysqli_fetch_array($query);
						?>
						<form action="php/subkriteria update.php" method="POST">
							<input type="hidden" class="form-control" name="id" value="<?php echo $row['id']; ?>">
							<div class="form-group">
								<label for="kd_subkriteria" class="control-label">Kode subkriteria</label>
								<input type="text" class="form-control" name="kd_subkriteria" placeholder="Kode subkriteria" value="<?php echo $row['kd_subkriteria']; ?>">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<a href="data subkriteria.php" class="btn btn-default">Kembali</a>
							</div>
						</form>
					</div>
				</div>            
